  ...
  return (
    <div className="shadow-sm border-b bg-white sticky top-0 z-50">
     ...
     <div className= "flex justify-between max-w-6xl mx-5 xl:mx-auto">
        ...
        <div className="relative w-10  lg:hidden flex-shrink-0 cursor-pointer2">
...
rounded-md"
 type="text" placeholder="Search"/>
        ...
        {session ? (
          ...
          <div className="absolute -top-1 -right-1 text-xs w-5 h-5 bg-red-500 rounded-full flex items-center justify-center 
